...
$allAppointments = $appointmentsCollection->find(['userId' => $userId]);
$appointmentStats = [
    'total' => 0,
    'pending' => 0,
    'completed' => 0,
...
foreach ($allAppointments as $apt) {
    ...
    if (isset($appointmentStats[$status])) {
...
<main class="main-content">
  <div class="dashboard-grid">
    ...
    <div class="dashboard-card" style="grid-column: span 1;">
      <h3 class="section-title">📊 Appointment Overview</h3>
    ...
    <div class="dashboard-card" style="grid-column: span 1;">
      ...
      <?php if ($firstAppointment): ?>
        <div class="appointment-highlight">
          ...
          <p class="mb-0">
            <span class="status-badge <?= strtolower($firstAppointment['status'] ?? 'pending') ?>">
      ...
      <?php else: ?>
        <div class="text-center py-4">
          ...
          <a href="services.php" class="btn btn-primary btn-sm mt-3">Book Appointment</a>
        </div>
      <?php endif; ?>
    </div>
...
<script>
const userId = <?php echo json_encode((string)$userId); ?>;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    events: 'get_user_appointments.php?userId=' + userId,
    eventColor: '#1e40af',
    eventTextColor: '#fff',
